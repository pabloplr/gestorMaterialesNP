                        ...
                        <table>
                            <tbody>
                                ...
                                for ($i = 0; $i < count($columna); $i++) {
                                    echo "<tr>";
                                    echo "<td class='cell100 column1'>" . $columna[$i]["dni"] . "</td>";
                                    echo "<td class='cell100 column2'>" . $columna[$i]["nombre_usuarios"] . "</td>";
                                    echo "<td class='cell100 column3'>" . $columna[$i]["apellidos"] . "</td>";
                                    echo "<td class='cell100 column4'>" . $columna[$i]["curso"] . "</td>";
                                    echo "<td class='cell100 column5'>" . $columna[$i]["ciclo"] . "</td>";
                                    echo "<td class='cell100 column6'>" . $columna[$i]["num_objetos"] . "</td>";
                                    echo "<td class='cell100 column7'><a href='../gestion/actualizar/actualizar-usuarios.php?varId2=" . $columna[$i]["dni"] . "'><img src='./../../img/editar.png'></a></td>";
                                    echo "<td class='cell100 column8'><a href='deleteUsuario.php?varId=" . $columna[$i]["dni"] . "'><img style='width: 50px' src='./../../img/delete.png'></a></td>";
                                    echo "</tr>";
                                }
