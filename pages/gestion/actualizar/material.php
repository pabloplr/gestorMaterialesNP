...
<html lang="en">
    ...
    <body>
        <form class="login100-form validate-form" action="material.php" method="POST">
            <div class="limiter">
                    ...
                    <div class="wrap-login100">
                        ...
                        <?php
                                ...
                                if ($numcolumnas != 0){
                                    ...
                                    echo "<script>location.href='actualizar-materiales.php';</script>";
                                } else {
                                    echo "<div class='alert alert-danger' role='alert' style='margin: auto;margin-top: 2rem;text-align: center;'>El número de serie introducido no está registrado.</div>";
                                }
