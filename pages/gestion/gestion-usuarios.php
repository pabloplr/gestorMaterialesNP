                    ...
                    if ($resultado = mysqli_query($conn, "SELECT dni FROM usuarios WHERE dni = '$dni'")) {
                        ...
                        if ($numcolumnas != 0){
                            if ($conn->query($sql) === TRUE){
                                echo "<div class='alert alert-success' role='alert' style='width: 70%;margin: auto;margin-top: 2rem;text-align: center;'>El usario con DNI '$dni' fue eliminado con éxito!</div>";
                            }
                        } else {
                            echo "<div class='alert alert-danger' role='alert' style='width: 70%;margin: auto;margin-top: 2rem;text-align: center;'>No existe ningún usuario con DNI '$dni'.</div>";
                        }
                    }
        ...
        <div class="modal fade" id="eliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="gestion-usuarios.php">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="background-color: white;">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="nserie" name="dni" class="form-control" placeholder="29853789A"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
