...
<html lang="en">
    ...
    <body>
        <form class="login100-form validate-form" action="usuario-devolucion.php" method="POST">
            <div class="limiter">
                    ...
                    <div class="wrap-login100">
                        ...
                        <?php
                               ...
                               if (isset($_POST["continuar"])){
                                ...
                                if ($resultado = mysqli_query($conn, "SELECT dni FROM prestamos WHERE dni = '$dni'")) {
